...
class ArticleModel extends ItemModel
{
     ...
     * @var        string
     */
    protected $_context = 'com_content_extended.article';
    ...
    protected function populateState()
    {
        ...
        $asset = empty($pk) ? 'com_content_extended' : 'com_content_extended.article.' . $pk;
    ...
    public function getItem($pk = null)
    {
        ...
        if (!isset($this->_item[$pk])) {
            try {
                ...
                if (
                    !$user->authorise('core.edit.state', 'com_content_extended.article.' . $pk)
                    && !$user->authorise('core.edit', 'com_content_extended.article.' . $pk)
                ) {
                ...
                if (!$user->guest) {
                    $userId = $user->id;
                    $asset  = 'com_content_extended.article.' . $data->id;
    ...
    /**
     * Cleans the cache of com_content_extended and content modules
     *
    ...
    {
        parent::cleanCache('com_content_extended');
