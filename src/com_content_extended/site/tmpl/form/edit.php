...
/** @var \Yepr\Component\Content_extended\Site\View\Form\HtmlView $this */
/** @var Joomla\CMS\WebAsset\WebAssetManager $wa */
$wa = $this->getDocument()->getWebAssetManager();
$wa->useScript('keepalive')
    ->useScript('form.validate')
    ->useScript('com_content_extended.form-edit');
...
<div class="edit item-page">
    ...
    <form action="<?php echo Route::_('index.php?option=com_content_extended&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
        <fieldset>
