...
namespace Yepr\Component\Content_extended\Administrator\Field\Modal;
...
class ArticleField extends ModalSelectField
{
    ...
    public function setup(\SimpleXMLElement $element, $value, $group = null)
    {
        ...
        Factory::getApplication()->getLanguage()->load('com_content_extended', JPATH_ADMINISTRATOR);
    ...
    protected function getRenderer($layoutId = 'default')
    {
        ...
        $layout->setComponent('com_content_extended');
        $layout->setClient(1);
