...
namespace Yepr\Component\Content_extended\Administrator\View\Article;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->canDo = ContentHelper::getActions('com_content_extended', 'article', $this->item->id);
    ...
    protected function addToolbar()
    {
        ...
        if ($isNew && (\count($user->getAuthorisedCategories('com_content_extended', 'core.create')) > 0)) {
            ...
            if (!$isNew) {
                if (ComponentHelper::isEnabled('com_content_extendedhistory') && $this->state->params->get('save_history', 0) && $itemEditable) {
                    $toolbar->versions('com_content_extended.article', $this->item->id);
                }
    ...
    protected function addModalToolbar()
    {
        ...
        $canCreate = $isNew && (\count($user->getAuthorisedCategories('com_content_extended', 'core.create')) > 0);
