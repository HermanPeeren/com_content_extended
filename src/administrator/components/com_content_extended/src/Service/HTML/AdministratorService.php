...
class AdministratorService
{
    ...
    public function association($articleid)
    {
        ...
        if ($associations = Associations::getAssociations('com_content_extended', '#__content', 'com_content_extended.item', $articleid)) {
            ...
            if ($items) {
                ...
                foreach ($items as &$item) {
                    if (\in_array($item->lang_code, $content_languages)) {
                        $text    = $item->lang_code;
                        $url     = Route::_('index.php?option=com_content_extended&task=article.edit&id=' . (int) $item->id);
