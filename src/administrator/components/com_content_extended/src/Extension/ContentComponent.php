...
/**
 * Component class for com_content_extended
 *
 * @since  4.0.0
 */
    ...
    TagServiceInterface
{
    ...
    {
        Factory::getLanguage()->load('com_content_extended', JPATH_ADMINISTRATOR);

        $contexts = [
            'com_content_extended.article'    => Text::_('COM_CONTENT'),
            'com_content_extended.categories' => Text::_('JCATEGORY'),
        ];
    ...
    public function countItems(array $items, string $section)
    {
        $config = (object) [
            ...
            'uses_workflows'      => true,
            'workflows_component' => 'com_content_extended',
        ];
