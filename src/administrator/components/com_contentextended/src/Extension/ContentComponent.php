...
/**
 * Component class for com_contentextended
 *
 * @since  4.0.0
 */
    ...
    TagServiceInterface
{
    ...
    {
        Factory::getLanguage()->load('com_contentextended', JPATH_ADMINISTRATOR);

        $contexts = [
            'com_contentextended.article'    => Text::_('COM_CONTENT'),
            'com_contentextended.categories' => Text::_('JCATEGORY'),
        ];
    ...
    public function countItems(array $items, string $section)
    {
        $config = (object) [
            ...
            'uses_workflows'      => true,
            'workflows_component' => 'com_contentextended',
        ];
