...
class AdministratorService
{
    ...
    public function association($articleid)
    {
        ...
        if ($associations = Associations::getAssociations('com_contentextended', '#__content', 'com_contentextended.item', $articleid)) {
            ...
            if ($items) {
                ...
                foreach ($items as &$item) {
                    if (\in_array($item->lang_code, $content_languages)) {
                        $text    = $item->lang_code;
                        $url     = Route::_('index.php?option=com_contentextended&task=article.edit&id=' . (int) $item->id);
