...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->canDo = ContentHelper::getActions('com_contentextended', 'article', $this->item->id);
    ...
    protected function addToolbar()
    {
        ...
        if ($isNew && (\count($user->getAuthorisedCategories('com_contentextended', 'core.create')) > 0)) {
            ...
            if (!$isNew) {
                if (ComponentHelper::isEnabled('com_contentextendedhistory') && $this->state->params->get('save_history', 0) && $itemEditable) {
                    $toolbar->versions('com_contentextended.article', $this->item->id);
                }
    ...
    protected function addModalToolbar()
    {
        ...
        $canCreate = $isNew && (\count($user->getAuthorisedCategories('com_contentextended', 'core.create')) > 0);
