...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_contentextended&task=featured.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
<form action="<?php echo Route::_('index.php?option=com_contentextended&view=featured'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <?php else : ?>
                    <table class="table itemList" id="articleList">
                        ...
                        <?php foreach ($this->items as $i => $item) :
                            ...
                            $assetId          = 'com_contentextended.article.' . $item->id;
                            $canCreate        = $user->authorise('core.create', 'com_contentextended.category.' . $item->catid);
                            ...
                            <tr class="row<?php echo $i % 2; ?>" data-transitions="<?php echo implode(',', $transition_ids); ?>">
                                ...
                                <th scope="row" class="has-context">
                                    <div class="break-word">
                                        ...
                                        <?php endif; ?>
                                        <?php if ($canEdit) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_contentextended&task=article.edit&return=featured&id=' . $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
