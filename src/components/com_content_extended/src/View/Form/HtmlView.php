...
namespace Yepr\Component\Content_extended\Site\View\Form;
    ...
    public function display($tpl = null)
    {
        ...
        if (empty($this->item->id)) {
            ...
            if ($this->state->params->get('enable_category') == 1 && $catid) {
                $authorised = $user->authorise('core.create', 'com_content_extended.category.' . $catid);
            } else {
                $authorised = $user->authorise('core.create', 'com_content_extended') || \count($user->getAuthorisedCategories('com_content_extended', 'core.create'));
            }
        } else {
        ...
        if (!empty($this->item->id)) {
            $this->item->tags->getItemTags('com_content_extended.article', $this->item->id);
        ...
        if (
            $this->item->id
            && ($user->authorise('core.create', 'com_content_extended') || \count($user->getAuthorisedCategories('com_content_extended', 'core.create')))
        ) {
