...
class ArchiveModel extends ArticlesModel
{
     ...
     * @var     string
     */
    public $_context = 'com_content_extended.archive';
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $limit  = $app->getUserStateFromRequest('com_content_extended.archive.list' . $itemid . '.limit', 'limit', $params->get('display_num', 20), 'uint');
