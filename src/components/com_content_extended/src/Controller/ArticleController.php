...
namespace Yepr\Component\Content_extended\Site\Controller;
...
class ArticleController extends FormController
{
    ...
    protected function allowAdd($data = [])
    {
        ...
        if ($categoryId) {
            ...
            $allow = $user->authorise('core.create', 'com_content_extended.category.' . $categoryId);
        }
    ...
    protected function allowEdit($data = [], $key = 'id')
    {
        ...
        if ($user->authorise('core.edit', 'com_content_extended.article.' . $recordId)) {
            return true;
        }

        // Check edit own on the record asset (explicit or inherited)
        if ($user->authorise('core.edit.own', 'com_content_extended.article.' . $recordId)) {
