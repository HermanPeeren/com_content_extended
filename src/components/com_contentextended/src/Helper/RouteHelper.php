...
abstract class RouteHelper
{
    ...
    {
        // Create the link
        $link = 'index.php?option=com_contentextended&view=article&id=' . $id;
    ...
    public static function getCategoryRoute($catid, $language = 0, $layout = null)
    {
        ...
        $link = 'index.php?option=com_contentextended&view=category&id=' . $id;
    ...
    {
        return 'index.php?option=com_contentextended&task=article.edit&a_id=' . (int) $id;
    }
}
