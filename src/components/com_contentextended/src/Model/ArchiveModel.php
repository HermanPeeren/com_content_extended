...
class ArchiveModel extends ArticlesModel
{
     ...
     * @var     string
     */
    public $_context = 'com_contentextended.archive';
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $limit  = $app->getUserStateFromRequest('com_contentextended.archive.list' . $itemid . '.limit', 'limit', $params->get('display_num', 20), 'uint');
