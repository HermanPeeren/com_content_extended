...
class ArticleModel extends ItemModel
{
     ...
     * @var        string
     */
    protected $_context = 'com_contentextended.article';
    ...
    protected function populateState()
    {
        ...
        $asset = empty($pk) ? 'com_contentextended' : 'com_contentextended.article.' . $pk;
    ...
    public function getItem($pk = null)
    {
        ...
        if (!isset($this->_item[$pk])) {
            try {
                ...
                if (
                    !$user->authorise('core.edit.state', 'com_contentextended.article.' . $pk)
                    && !$user->authorise('core.edit', 'com_contentextended.article.' . $pk)
                ) {
                ...
                if (!$user->guest) {
                    $userId = $user->id;
                    $asset  = 'com_contentextended.article.' . $data->id;
    ...
    /**
     * Cleans the cache of com_contentextended and content modules
     *
    ...
    {
        parent::cleanCache('com_contentextended');
