    ...
    public function display($tpl = null)
    {
        ...
        if (empty($this->item->id)) {
            ...
            if ($this->state->params->get('enable_category') == 1 && $catid) {
                $authorised = $user->authorise('core.create', 'com_contentextended.category.' . $catid);
            } else {
                $authorised = $user->authorise('core.create', 'com_contentextended') || \count($user->getAuthorisedCategories('com_contentextended', 'core.create'));
            }
        } else {
        ...
        if (!empty($this->item->id)) {
            $this->item->tags->getItemTags('com_contentextended.article', $this->item->id);
        ...
        if (
            $this->item->id
            && ($user->authorise('core.create', 'com_contentextended') || \count($user->getAuthorisedCategories('com_contentextended', 'core.create')))
        ) {
