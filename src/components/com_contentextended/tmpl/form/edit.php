...
$wa->useScript('keepalive')
    ...
    ->useScript('com_contentextended.form-edit');
...
<div class="edit item-page">
    ...
    <form action="<?php echo Route::_('index.php?option=com_contentextended&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
        <fieldset>
